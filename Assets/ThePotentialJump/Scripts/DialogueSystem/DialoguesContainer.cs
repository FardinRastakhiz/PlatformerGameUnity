...
{
    public static class DialoguesContainer
    {
        public const string Dialogues = @"
			{
			""1"":{
				""1"": {
					""id"": ""dialogue-1-1"",
				...
				""4"": {
					""id"": ""dialogue-1-1"",
					""speaker"": ""Evelyn"",
					""paragraph"": ""Gravity is a force between objects that pull each other. Everything with mass has gravity relative to its weight and position. We cannot see the small gravities."",
					""titleAlignment"": ""Left""
					},
				""5"": {
					""id"": ""dialogue-1-1"",
					""speaker"": ""Evelyn"",
					""paragraph"": ""But Earth is so massive and heavy, and because we are on Earth and close to it, we can see and feel its gravity. The moon is so big and heavy, too."",
					""titleAlignment"": ""Left""
					},
				""6"": {
					""speaker"": ""Evelyn"",
					""paragraph"": ""Both objects' gravities pull each other the same, but for smaller object pairs, the amount of gravitational energy is smaller, too."",
					""titleAlignment"": ""Left""
					},
				""7"": {
					""id"": ""dialogue-1-1"",
